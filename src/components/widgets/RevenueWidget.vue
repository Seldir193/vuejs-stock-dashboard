...
import arrowDown   from '@/assets/img/arrow_downward_alt.png';   // ⬅︎ neues Icon
...
const deltaAbs  = computed(() => diff.value / 1_000); // in Mrd
...
.label  { opacity: 0.8;  font-family: Rubik;
font-weight: 400;
font-size: 12px;
line-height: 100%;
letter-spacing: 0%;
 }
.row    { display: flex; justify-content: space-between; flex: 1; }
.value-box { display: flex; flex-direction: column; justify-content: space-between; }
.value  {   font-family: Rubik;
font-weight: 500;
font-size: 24px;
line-height: 100%;
letter-spacing: 0%;
 }
.unit   {   opacity: 0.8; margin-top: 4px;  font-family: Rubik;
font-weight: 400;
font-size: 8px;
line-height: 100%;
letter-spacing: 0%;
}
.delta-box { display: flex; flex-direction: column; align-items: flex-end;  }
.delta  { display: flex; align-items: center; font-family: Rubik;
font-weight: 500;
font-size: 13px;
line-height: 100%;
letter-spacing: 0%;
...
.percent {  margin-top: 2px; display:flex; align-items:center; font-family: Rubik;
font-weight: 500;
font-size: 13px;
line-height: 100%;
letter-spacing: 0%;
...
.title-row {
  display: flex;
  align-items: center;
  gap: 6px;           /* Abstand Logo–Text */
}

.logo {
  width: 20px;        /* oder 24 px laut Figma */
  height: 20px;
  object-fit: contain;
}
